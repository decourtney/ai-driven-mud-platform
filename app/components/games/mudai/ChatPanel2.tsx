...
import { ChatMessage, CharacterState } from "@/app/types/game";
import { NpcsState, SceneState } from "./GamePage2";
...
export default function ChatPanel({
  ...
  const getMessageStyle = (speaker: ChatMessage["speaker"]) => {
    switch (speaker) {
      case "player":
