              ...
              <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex-1">
                  ...
                  <Link href={`play/${featuredGame.slug}`}>
                    <button className="bg-green-600/60 hover:bg-green-700 text-black font-mono font-bold px-8 py-4 text-lg transition-colors flex items-center border-2 border-green-400">
