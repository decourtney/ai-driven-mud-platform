...
from backend.services.api.models.action_models import ParsedAction, ActionType
...
class MockNarrator:
    ...
    def __init__(self):
        ...
        self.templates = {
            ActionType.attack: {
                ...
                "failure": {"miss": "{actor} swings at {target} but misses."},
            },
            ActionType.spell: {
                "hit": {
            ...
            ActionType.SKILL_CHECK: {
                ...
                "failure": {"failure": "{actor} fails to complete {action}."},
            },
            ActionType.social: {
                "hit": {
            ...
            ActionType.movement: {
                ...
                "failure": {"failure": "{actor} stumbles while attempting {action}."},
            },
            ActionType.interact: {
                "hit": {
    ...
    def generate_input_narration(
        self,
        action: ParsedAction,
        dice_roll: int,
        hit: bool,
        damage_type: str = "wound",
    ) -> str:
