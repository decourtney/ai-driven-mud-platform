...
class DnDGameEngine(BaseGameEngine):
    ...
    def validate_action_constraints(self, parsed_action: ParsedAction) -> ValidationResult:
        ...
        actor_state = (self.game_state.player if parsed_action.actor == "player" 
        ...
        if parsed_action.action_type == ActionType.ATTACK:
            if not actor_state.equipped_weapon and not actor_state.has_natural_weapons:
                return ValidationResult(False, "No weapon equipped or natural weapons available", 
            ...
            if actor_state.current_mp <= 0:
                return ValidationResult(False, "Not enough mana to cast spells", 
