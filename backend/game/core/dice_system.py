...
class BaseDiceRoller(DiceRoller, ABC):
    ...
    def roll_exploding(self, sides: int, explode_on: Optional[int] = None) -> Tuple[int, List[int]]:
        """
    ...
    def roll_keep_highest(self, count: int, sides: int, keep: int) -> Tuple[int, List[int]]:
    ...
    def roll_keep_lowest(self, count: int, sides: int, keep: int) -> Tuple[int, List[int]]:
    ...
    def is_critical(self, raw_roll: int | List[int], hit: bool, action_type: str) -> bool:
